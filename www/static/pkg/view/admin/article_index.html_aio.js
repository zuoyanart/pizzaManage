...
/*!admin/article*/
;define('admin/article', function(require, exports, module) {
              ...
              success: function success(msg) {
                  if (msg.state == true) {
                      ...
                      if (ispass == "true") {
                          ...
                          for (var i = 0, ll = ids.length; i < ll; i++) {
                              console.log(ids[i]);
                              var oo = $('#article_' + ids[i]).parent().parent();
                              oo.find('b').remove();
